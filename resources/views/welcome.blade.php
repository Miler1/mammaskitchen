...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#">Mamma's Kitchen.</a> Developed by <a href="https://github.com/Miler1">Miler Grudtner Boell </a>Theme by <a href="http://themewagon.com/" target="_blank">Themewagon</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script src="{{ asset('frontendjs/jquery.validate.js') }}"></script>
